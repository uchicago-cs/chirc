...
If you are accustomed to using SVN, we suggest that, at first, you use Git in an ``SVN-like'' manner, without using some of Git's bells and whistles (in fact, you can find a mapping of SVN commands to Git commands in the Git SVN Crash Course: \url{http://git.or.cz/course/svn.html}).
...
To learn more about Git, you can find a quick introduction here:

\begin{center}
\url{http://learn.github.com/p/index.html}
\end{center}
...
\begin{center}
\url{https://github.com/uchicago-cs/GROUP_NAME}
\end{center}
...
\begin{example}
git remote add origin git@github.com:uchicago-cs/GROUP_NAME.git
\end{example}
...
upstream	git://github.com/uchicago-cs/chirc.git (fetch)
upstream	git://github.com/uchicago-cs/chirc.git (push)
origin 		git@github.com:uchicago-cs/GROUP_NAME.git (fetch)
origin 		git@github.com:uchicago-cs/GROUP_NAME.git (push)
\end{example}
